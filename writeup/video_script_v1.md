# Video Script v1 — Gemma Rescue Grid
...
| 4 | 0:30–0:38 | Reveal: a responder in a yellow vest holds up an ordinary Android phone. Tight on the screen — the responder taps the airplane mode toggle ON. The little plane icon glows. | *"We built Gemma Rescue Grid to give that hour back."* | Music shifts: hopeful, electronic, slow build |
...
| 11 | 2:30–2:50 | Cut back to dramatic disaster footage. Quiet now. Then cut to a smiling field worker holding the phone, looking off-camera. End on big text: **GEMMA RESCUE GRID** with a one-line tagline. | *"Eight hundred million people live more than three hours from a hospital. There are four billion phones in the world. Gemma 4 puts a first responder in every pocket. Built for the moments that matter."* | Music resolves |
